############################################
### Applying sfFDR / MTAG to null case 2 ###
############################################
source("../00-helper.R")
...
for (i in  1:10) {
   ...
   # arg_sumstats <- paste0("./data/bmi.txt,", "./data/bfp.txt")
    ...
    #save(df_cor, file = paste0("./data/06b-null-bmi-bfp-", i, ".rds"))
    save(df_cor, file = paste0("./data/06b-null-bmi-tri-bfp-cho-", i, ".rds"))  
}
